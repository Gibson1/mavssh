...
public class UserAction extends ActionSupport {
	...
	public String login() {
		...
		if (1 == 2 && !currentSession.isEmpty() && currentSession.containsKey("uid")
				&& !currentSession.get("uid").equals("")) {
			...
			/*
			 * // search User by query String searchUser=
			 * "From User u where u.name = :name"; Query query =
			 * session.createQuery(searchUser);
			 * query.setParameter("name",user.getName()); List results = (List)
			 * query.list();
			 */
